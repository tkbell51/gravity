...
export default {
    ...
    styleResources: {
        scss: ['~assets/scss/_breakpoints.scss', '~assets/scss/_mixins.scss', '~assets/scss/_variables.scss'],
    },
    fontawesome: {
        imports: [
            {
            ...
            },
            {
                ...
                icons: ['faDev', 'faFacebook', 'faTwitter', 'faLinkedin', 'faInstagram', 'faYoutube'],
            },
        ],
    },
    sitemap: {
