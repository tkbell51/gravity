        ...
        <div class="footer__main">
            <div class="container">
                <div class="footer__box">
                    ...
                    <div>
                        <h4 class="footer__menu--title">Information</h4>
                        <ul class="footer__menu">
                            ...
                            <li class="footer__item">
                                <nuxt-link class="footer__link" to="/contact">Contact Us</nuxt-link>
                            </li>
                        </ul>
                    </div>
                    <div class="footer__pages">
                        <h4 class="footer__menu--title">Services</h4>
                        <ul class="footer__menu">
                            <li class="footer__item">
                                <nuxt-link class="footer__link" to="/services/individual-therapy"
                                >Individual Therapy</nuxt-link
                                >
                            </li>
                            <li class="footer__item">
                                <nuxt-link class="footer__link" to="/services/couples-therapy"
                                >Couples Therapy</nuxt-link
                                >
                            </li>
                            <li class="footer__item">
                                <nuxt-link class="footer__link" to="/services/teletherapy">Teletherapy</nuxt-link>
                            </li>
                            <li class="footer__item">
                                <nuxt-link class="footer__link" to="/services/anger-management"
                                >Anger Management</nuxt-link
                                >
                            </li>
                            <li class="footer__item">
                                <nuxt-link class="footer__link" to="/services/support-groups">Support Groups</nuxt-link>
                            </li>
                            <li class="footer__item">
                                <nuxt-link class="footer__link" to="/services/workshops-presentations"
                        ...
                        <ul class="footer__menu">
                            <li class="footer__item">
                                <nuxt-link
                                    ...
                                    ><Fas class="footer__icon" i="map-marker-alt" />104 Maxwell Ave Suite 219,<br />
                            ...
                            <li class="footer__item">
                                <nuxt-link class="footer__link contact-flex" to="tel:864-724-9187"
                                    ><Fas class="footer__icon" i="phone" />(864) 724-9187</nuxt-link
                                >
                            </li>
                        </ul>
                    </div>
            ...
            <div class="footer__bottom">
                <div class="container">
                    <div class="footer__bottom--box">
                        <p>Copyright &copy; {{ new Date().getFullYear() }} Gravity Counseling Group</p>
                        <div class="footer__social">
                            <ul class="footer__menu">
                                <li v-for="item in social" :key="item.name" class="footer__item">
                                    <a class="footer__link" :href="item.link" target="_blank" :title="item.name"
                                    ><Fab class="footer__icon" :i="item.name"
                                    /></a>
                                </li>
                            </ul>
                        </div>
